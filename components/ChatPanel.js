...
export default function ChatPanel({ onClose }) {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-30 z-50 flex justify-end">
            <div
                ref={panelRef}
                className="w-full md:w-80 lg:w-96 bg-white h-full shadow-xl flex flex-col"
            >
                {/* Header */}
                ...
                <div className="p-4 border-t bg-white">
                    <div className="flex items-center space-x-2">
                        <input
                            type="text"
                            className="flex-1 px-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-orange-500 text-base"
